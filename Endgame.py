...
music = arcade.sound.load_sound('sound/bgmusic2.mp3')
...
class MyWindow(arcade.Window):
    ...
    def game_setup(self, width, height):
        ...
        self.bullet_sprite = BulletSprite('images/enermy1.png', model=self.world.bullet)
        ...
        for i in PLAYER_PIC:
            if i != 3:
                ...
                self.cycle = 0
        self.platback = arcade.load_texture('images/plat5.png', scale=SCALE)
        self.background = arcade.load_texture("images/city01.jpg")
    ...
    def on_draw(self, line_start=0):
        ...
        if self.world.state == 1:
            ...
            arcade.draw_text(f"fps{self.fpscounter.fps():.2f}", self.world.player.x + (SCREEN_WIDTH // 3) - 10,
                             self.height - 50, arcade.color.BLACK)
